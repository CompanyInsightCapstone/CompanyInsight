...
class DiskWriter:
    ...
    def write_batch_to_disk(self):
        ...
        try:
            ...
            print(f"Wrote entries to {self.file_name}")
    ...
    def process_buffer(self):
        """Process items from the buffer until the buffer is empty and marked as done."""
        while (
    ...
    def run(self):
        """Main method to run in a process. Process items from buffer and write to disk."""
        try:
