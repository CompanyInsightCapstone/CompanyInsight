...
from nss_model.data_processing.tokenizer import Tokenizer
...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, data, tokenizer_name='bert-base-uncased', max_length=128):
        ...
        self.numerical_features_keys = ['close', 'open', 'high', 'low', 'volume', 'simpleMovingAverage']
    ...
    def __getitem__(self, idx):
        ...
        numerical_features = [document_info.get(key, 0.0) for key in self.numerical_features_keys]
